...
/**
 * Interface describing PropertyChange API behaviour for the GameState class.
 * @author Raiden H
 * @version May 9 2025
 */
public interface PropertyChangeEnabledGameState {
    /**
     * Constant string property name for position changing.
     */
